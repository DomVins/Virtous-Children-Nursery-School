                ...
                children: [
                              ...
                              pw.Align(
                                  ...
                                  child: pw.Container(
                                      ...
                                      decoration: const pw.BoxDecoration(
                                          ...
                                          color: PdfColors.red),
                                      child: pw.Text(
                                          'TERMLY CONTINOUS ASSESSMENT FOR NURSERY SCHOOL',
                                          style: pw.TextStyle(
                                              fontSize: 15,
                                              fontWeight: pw.FontWeight.bold,
                                              color: PdfColors.white)))),
                  ...
                  pw.Column(
                      ...
                      children: [
                        ...
                        pw.SizedBox(height: 8),
                        pw.Text("Head Teacher's Remark: ${htremarkHelper(MainStore.classes[widget.index].terms[widget.termIndex].students[i].average)}",
                            style: pw.TextStyle(
                              fontSize: 12,
                              fontWeight: pw.FontWeight.bold,
                            )),
